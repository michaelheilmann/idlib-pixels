...
#if !defined(IDLIB_PIXELS_PIXEL_FORMAT_H_INCLUDED)
#define IDLIB_PIXELS_PIXEL_FORMAT_H_INCLUDED

#include "idlib/pixels/common.h"
...
#endif // IDLIB_PIXELS_PIXEL_FORMAT_H_INCLUDED
